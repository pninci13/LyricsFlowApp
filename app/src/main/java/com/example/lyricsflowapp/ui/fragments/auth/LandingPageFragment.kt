...
import com.example.lyricsflowapp.databinding.FragmentLandingPageBinding
...
class LandingPageFragment : Fragment() {
    ...
    private fun initClicks() {
        binding.signUpBtn.setOnClickListener{
            findNavController().navigate(R.id.action_landingPageFragment_to_registerAccountFragment)
        }
